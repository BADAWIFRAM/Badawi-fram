...
<head>
  ...
  <style>
    body {
      ...
      margin: 0;
      padding: 0;
      background-image: url('https://images.unsplash.com/photo-1598514983033-99d9e46f7c03?auto=format&fit=crop&w=1350&q=80'); /* background ayam/telur */
    ...
    select, input { padding: 10px; border-radius: 6px; border: 1px solid #ccc; font-size: 16px; }
    button {
      margin-top: 20px; padding: 14px; width: 100%; border: none; border-radius: 6px;
    ...
    footer { text-align: center; margin-top: 30px; color: #fff; font-size: 14px; text-shadow: 1px 1px 2px #000; }
    img.main-photo { width: 100%; border-radius: 10px; margin-top: 15px; }
  </style>
</head>
<body>

<header>
  <img src="https://via.placeholder.com/150x150.png?text=BADAWI+FRAM" alt="BADAWI FRAM Logo" class="logo" />
  <h1>BADAWI FRAM</h1>
...
<div class="container">
  <img src="https://images.unsplash.com/photo-1581189734906-51f7f36a9305?auto=format&fit=crop&w=800&q=80" class="main-photo" alt="Telur BADAWI FRAM">
